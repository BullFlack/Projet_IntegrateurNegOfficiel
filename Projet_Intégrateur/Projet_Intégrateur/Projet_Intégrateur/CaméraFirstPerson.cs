    ...
    public class CaméraFirstPerson: Caméra
    {
       ...
       public bool InView(BoundingSphere boundingSphere)
        ...
        private void GérerDéplacement()
        {
            ...
            BBCaméra = CalculerBB(nouvellePosition);
            bool BB = true;
        ...
        private BoundingBox CalculerBB(Vector3 NouvellePosition)
        {
            BoundingBox BBCaméra = new BoundingBox(new Vector3(NouvellePosition.X - 1, NouvellePosition.Y - 1, NouvellePosition.Z - 1),
                                                   new Vector3(NouvellePosition.X + 1, NouvellePosition.Y + 1, NouvellePosition.Z + 1));
            return BBCaméra;
        }
