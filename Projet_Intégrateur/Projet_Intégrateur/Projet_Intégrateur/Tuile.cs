...
namespace AtelierXNA
{
   public abstract class Tuile : PrimitiveDeBaseAnimée
   {
      ...
      {
          BBTuile = new BoundingBox(new Vector3(PtsSommets[0, 0].X - 1, PtsSommets[0, 0].Y - 1, PtsSommets[0, 0].Z - 1), new Vector3(PtsSommets[1, 1].X + 1, PtsSommets[1, 1].Y + 1, PtsSommets[1, 1].Z +1));
      }
