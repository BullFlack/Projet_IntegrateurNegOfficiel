...
namespace AtelierXNA
{
    ...
    public class MenuJeu : DrawableGameComponent
    {
        ...
        {
            //Game.Components.Remove(LeJeu);
            //Game.Components.Add(new MenuOption(Game, "imageFondMenu", new Rectangle(0, 0,Game.Window.ClientBounds.Width,  Game.Window.ClientBounds.Height)));
        }
